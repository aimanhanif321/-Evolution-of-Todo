...
function TaskCard({ task, onUpdate, onEdit }) {
    ...
    const toggleComplete = async ()=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].patch(`/api/${user.id}/tasks/${task.id}/complete`, {
    ...
    const deleteTask = async ()=>{
        ...
        setLoading(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/api/${user.id}/tasks/${task.id}`, token);
            onUpdate();
        } catch (error) {
...
_s(TaskCard, "7O4GVaH91UULwgfV0oCjArOLdNo=", false, function() {
    return [
...
"[project]/frontend/src/components/TaskForm.tsx [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
function TaskList() {
    ...
    const fetchTasks = async ()=>{
        ...
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/api/${user.id}/tasks`, token);
...
//# sourceMappingURL=frontend_4e3bafef._.js.map