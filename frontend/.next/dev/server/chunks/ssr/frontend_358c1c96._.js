...
"[project]/frontend/src/components/TaskCard.tsx [app-ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
function TaskForm({ onClose, onSuccess, editTask }) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (editTask) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/api/tasks/${editTask.id}`, payload, token);
            } else {
                // await APIClient.post(`/api/tasks`, payload, token);
                await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`/api/tasks`, payload, token);
            }
            onSuccess();
            onClose();
        } catch (err) {
...
function TaskList() {
    ...
    const fetchTasks = async ()=>{
        ...
        try {
            // GET /api/tasks
            const tasksFromApi = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/api/tasks`, token);
...
//# sourceMappingURL=frontend_358c1c96._.js.map