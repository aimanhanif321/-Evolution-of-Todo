...
function TaskCard({ task, onUpdate, onEdit }) {
    ...
    const toggleComplete = async ()=>{
        ...
        setLoading(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].patch(`/api/tasks/${task.id}/complete`, {
    ...
    const deleteTask = async ()=>{
        ...
        setLoading(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/api/tasks/${task.id}`, token);
            onUpdate();
        } catch (err) {
...
//# sourceMappingURL=frontend_a1abdc2a._.js.map